...
This module can be used to explore the effects of different parameters on the upconversion yield of an acceptor molecule system.

The upconversion yield for an acceptor molecule systems is defined as:

.. math::

   \Phi_{UC}^{(a)}=\frac{2k_{SNR}[S_1]}{G}

Therefore the maximum possible value is 100%.
...
.. automodule:: tripletpairs.toolkit.ttauc
   :members: